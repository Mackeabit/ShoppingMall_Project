...
<meta charset="UTF-8">
<link rel="stylesheet"
	href="${ pageContext.request.contextPath }/resources/css/review/review_list.css?after">
					...
					<div id="review_box">
						...
						<div id="review_select">
							<form>
								...
								</select> <input type="button" value="조회" onclick="send(this.form);">
							</form>
						</div>
						...
						<table>
							...
							<c:forEach var="vo" items="${list }">
								<tr>
									...
									<td><button type="button" onclick="location.href='admin_review_detail.do?rv_idx=${vo.rv_idx}'">
										상세보기</button>
									</td>
								</tr>
							</c:forEach>
